...
public static float pouzeCisla(Scanner sc) 
{
    ...
    public static void main(String[] args)  {
        Animovanefilmy filmy = new Animovanefilmy(); 
        ...
        while (true) {
            ...
            switch (volba) {
                ...
                case 3:
                    ...
                    boolean result = filmy.setHodnotenie(meno, (int) hodnotenie); 
                    if (result) {
